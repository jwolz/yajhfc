...
\item[Windows XP:]
You can use the integrates ``picture and fax viewer'' (sorry, I don't know
...
\texttt{faxcover} program uses. See the follwing pages for hints how to create/edit
such files: \\
...
file type using the extension if PCL is reported (which usually works pretty well).
