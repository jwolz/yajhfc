...
\ttfamily @@PageCount@@ & Die Seitenanzahl ohne das Deckblatt selbst \\\hline
...
--logfile    Die Logdatei, in die die Debugging-Informationen geschrieben werden
             (falls nicht angegeben, benutze die Standardausgabe (stdout))
...
--no-plugins Deaktiviert das Laden von Plugins aus der plugin.lst-Datei.
