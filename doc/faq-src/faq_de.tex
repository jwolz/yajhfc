...
\subsection{Warum ist der Menüeintrag \texttt{Ansicht->Gescheiterte Aufträge markieren} ausgegraut?}

Aus dem selben Grund wie schon im vorherigen Absatz: YajHFC kann nur mit sichtbaren Tabellenspalten arbeiten.
Zum Erkennen gescheiterter Aufträge ist es also notwendig, dass folgende Spalten sichtbar sind:
\begin{description}
\item[Empfangene Faxe:] \texttt{Fehlerbeschreibung}
\item[Gesendete/Sendende Faxe:] \texttt{Auftragsstatus} \emph{oder} \texttt{Status}
\end{description}
