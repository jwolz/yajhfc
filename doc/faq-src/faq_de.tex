...
-r, --recipient=EMPFÄNGER    Gibt einen Faxempfänger an. Sie können entweder
                             ...
                             --recipient mehrmals angeben für mehrere Empfänger.
...
-s, --subject=BETREFF        Der Betreff des Faxes für das Deckblatt.
    ...
    --stdin                  Lese die zu sendende Datei von der Standardeingabe.
...
-l, --logfile=LOGDATEI       Die Logdatei, in die die Debugginginformationen
    ...
    --appendlogfile=LOGDATEI Hänge die Debugginginformationen an die angegebene
                             Logdatei an.
    --background             Falls noch keine Instanz von YajHFC läuft, erstelle
                             eine neue Instanz und beende diese Instanz (nachdem
                             das zu sendende Fax abgeschickt wurde)
    --noclose                YajHFC nach Absenden des Faxes nicht schließen.
-T, --showtab=0|R|1|S|2|T    Setzt den beim Start anzuzeigenden Tab. Geben Sie 0
                             oder R für den Tab "Empfangen", 1 oder S für
                             "Gesendet" oder 2 oder T für "Sendend" an.
    --loadplugin=JARDATEI    Gibt die JAR-Datei eines zu ladenden YajHFC-Plugins
                             an.
    ...
    --no-gui                 Sende ein Fax mit einer nur minimalen graphischen
                             Oberfläche.
    --no-check               Unterdrückt die Prüfung der Javaversion beim Start.
...
\textit{Vorteil:} Die Auflösung wird auf 196dpi reduziert (\textrightarrow kleinere Dateien/kleinerer Upload) und eine einzige Dokumentendatei kann bei einem Fax an mehrere Empfänger verwendet werden.
\medskip
