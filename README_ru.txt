...
Требования:
* JRE 5.0 или выше (рекомендуется Java 6 или 7)
...
Для установки YajHFC просто скачайте файл yajhfc-0_5_7.jar в любой каталог.
Чтобы запустить, используйте: "java -jar yajhfc-0_5_7.jar"
...
0.5.5:
- Встроенной поддержка libtiff в плагине PDF (дает поддержку JBIG и лучшую совместимость с не на 100% чистыми TIFFами)
