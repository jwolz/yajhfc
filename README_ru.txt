...
* Поддерживает пять языков: Английский, Французский, Немецкий, Русский и Испанский
...
* Необязательно: программа для просмотра файлов PostScript (например Ghostview)

Для установки YajHFC просто скачайте файл yajhfc-0_3_9.jar в любой каталог.
Чтобы запустить, используйте: "java -jar yajhfc-0_3_9.jar"
...
(чем продвинутые программы "Hello world") проект Java с помощью Eclipse IDE.
...
В будущем возможно будут добавлены следующие функции:
