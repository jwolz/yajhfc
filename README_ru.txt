...
Для установки YajHFC просто скачайте файл yajhfc-0_3_8.jar в любой каталог.
Чтобы запустить, используйте: "java -jar yajhfc-0_3_8.jar"
