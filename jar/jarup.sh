...
jar cvfm $JARFILE $DIR/manifest.txt yajhfc/*.class yajhfc/i18n/*.class yajhfc/*.png COPYING README*.txt doc/*.html doc/*.css yajhfc/faxcover/*.class yajhfc/faxcover/*.ps yajhfc/filters/*.class yajhfc/phonebook/*.class yajhfc/phonebook/jdbc/*.class
