...
public abstract class DefaultEntryToStringRule implements EntryToStringRule {
    /* (non-Javadoc)
     * @see yajhfc.phonebook.convrules.EntryToStringRule#applyRule(yajhfc.phonebook.PhoneBookEntry)
     */
    ...
    /* (non-Javadoc)
     * @see yajhfc.phonebook.convrules.EntryToStringRule#applyRule(yajhfc.phonebook.PhoneBookEntry, java.lang.StringBuilder)
     */
