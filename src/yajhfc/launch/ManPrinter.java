...
public class ManPrinter extends HelpPrinter {
    ...
    protected void printManHeader(PrintWriter out, String commandName, InputStream READMEstream) throws Exception {
        Date now = new Date();
        out.append(
...
//        ".br\n"
    ...
    public void printManPage(PrintWriter out, LongOpt[] options) throws Exception {
        printManPage(out, options, "yajhfc", ManPrinter.class.getResourceAsStream("/README.txt"));
    }
     ...
     * @throws IOException 
     */
    public void printManPage(PrintWriter out, LongOpt[] options, String commandName, InputStream READMEstream) throws Exception {
        options = filterOptions(options);
        
        printManHeader(out, commandName, READMEstream);
