...
public enum QueueFileFormat implements FmtItem {
        ...
        desiredtl("desiredtl", _("Tagline"),Utils._("Whether or not to use tagline parameter"), Integer.class), 
        ...
        minsp("minsp", _("Minimum speed"), Utils._("Minimum required transmit speed"), Integer.class), 
        ...
        pagechop("pagechop", _("Page chop handling"), Utils._("Whitespace truncation handling"), String.class), 
