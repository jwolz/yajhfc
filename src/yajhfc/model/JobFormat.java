...
public enum JobFormat implements FmtItem {
     ...
     * Desired data format
     */
    H("H", _("Desired data format"), Integer.class), 
    /**
     * Priority
     */
     ...
     * Private Tagline?
     */
    N("N", _("Private Tagline?"), _("Desired use of private tagline (one-character symbol)"), Boolean.class), 
    /**
     * Use continuation cover
     */
    O("O", _("Use continuation cover"), _("Whether to use continuation cover page (one-character symbol)"), Boolean.class), 
    /**
     * Pages done/total
     */
     ...
     */
    f("f", _("# consecutive failed dials"), Integer.class), 
    /**
     * Group identifier
     */
    g("g", _("Group identifier"), Integer.class), 
    /**
     * Page chop handling
     */
     ...
     * Scheduling priority
     */
    i("i", _("Scheduling priority"), _("Current scheduling priority"), Integer.class), 
    /**
     * ID
     */
    ...
    /**
     * Virtual column: Phone book name
     */
    virt_resolvedname(null, _("Phone book name"), _("Name looked up from phone book"), String.class, null, null, true, VirtualColumnType.RESOLVED_NAME),
    ;
